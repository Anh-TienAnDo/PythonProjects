...
class BanHang:
    def __init__(self, id=None, id_mat_hang=None, ten_hang=None, don_vi=None, so_luong=None, gia_ban=None, khach_hang=None, thanh_tien=None, ghi_chu=None, ngay_ban=None):
        self.id = id if id is not None and BAN_HANG_ID_PREFIX in id else GenerationId.generate_id(BAN_HANG_ID_LENGTH, BAN_HANG_ID_PREFIX)
        ...
        self.gia_ban = int(gia_ban) if gia_ban is not None and str(gia_ban).strip().isdigit() else 0
