...
# #
# # def save_sensor_history(nhiet_do, do_am, do_am_dat, anh_sang, topic):
# #     """
...
# #         return
# #     try:
# #         print("save_sensor_history")
# #         print(land)
# #         history_sensor = LichSuCamBien.objects.create(manhdat=land, nhiet_do=nhiet_do, do_am=do_am,
...
# #
# #     # Lưu lịch sử dữ liệu cảm biến
# #     print(nhiet_do, do_am, do_am_dat, anh_sang)
# #     save_sensor_history(nhiet_do, do_am, do_am_dat, anh_sang, topic)
# #
# #     # Xử lý điều khiển
...
#             action_land['fan'] = 1
#             is_send = True
#         elif nhiet_do <= dieukhien_land.fan_off and action_land['fan'] == 1:
#             action_land['fan'] = 0
#             is_send = True
#         # --------------------
#         if do_am_dat <= dieukhien_land.water_pump_on and action_land['water_pump'] == 0:
#             action_land['water_pump'] = 1
#             is_send = True
#         elif do_am_dat >= dieukhien_land.water_pump_off and action_land['water_pump'] == 1:
#             action_land['water_pump'] = 0
#             is_send = True
#         # --------------------
#         # time lamp
