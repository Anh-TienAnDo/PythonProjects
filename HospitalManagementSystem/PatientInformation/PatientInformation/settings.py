"""
Django settings for PatientInformation project.
...
SECRET_KEY = 'django-insecure-yk6_gy+bfykg*)f@)4b^saukf31w3=^n*v3z$ipr93$rydjsvs'
...
ROOT_URLCONF = 'PatientInformation.urls'
...
WSGI_APPLICATION = 'PatientInformation.wsgi.application'
