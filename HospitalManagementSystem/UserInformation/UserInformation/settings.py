"""
Django settings for UserInformation project.
...
SECRET_KEY = 'django-insecure-(*0$y8i&ser=kjx5!8uc-2d+gq4foa#or-svq80m@e%tl)!2o@'
...
ROOT_URLCONF = 'UserInformation.urls'
...
WSGI_APPLICATION = 'UserInformation.wsgi.application'
...
AUTH_USER_MODEL = "UserModel.Account"
